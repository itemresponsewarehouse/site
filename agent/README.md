...
Open the site (e.g. http://localhost:4200). Click the chat button (bottom-right) and ask e.g. "I need child math assessment data with many participants" or "How do I fetch datasets with response time in R?"
